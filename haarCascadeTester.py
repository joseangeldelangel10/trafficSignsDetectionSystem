...
classifier = cv.CascadeClassifier("D:/tecdemty/6to Semestre/robotica inteligente/signsDetectionModel2/redHexagons/classifier/cascade.xml")
...
while True:
	...
	red1 = cv.inRange(HSV,(145,30,50),(180,255,255))
	red2 = cv.inRange(HSV,(0,30,50),(10,255,255))
	red = cv.bitwise_or(red1,red2)
	
	"""sign = classifier.detectMultiScale(red, scaleFactor=1.1, minNeighbors=400, minSize=(40,40))
	for (x,y,w,h) in sign:
